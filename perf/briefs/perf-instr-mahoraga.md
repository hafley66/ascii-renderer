# perf-instr-mahoraga: wrap painters in measure_layer (pass 1 of 2)
...
src/mahoraga2.rs, src/mahoraga3.rs, src/mahoraga4.rs, src/mahoraga5.rs

## Modes to instrument (registry names, use them verbatim as the first measure_layer argument)

mahoraga-2, mahoraga-3, mahoraga-4, mahoraga-5 (these are the slowest modes in perf/results/SUMMARY.md, 1 to 3 fps at 2000x1000; the hotspot table is the point)
