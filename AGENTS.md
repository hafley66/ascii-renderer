...
- All AI art carries its prompt sequence: the verbatim prompts and steering messages that produced it, in order, committed in the worktree before the first long agentic turn finishes (the first pass after the work reaches a tested implementation).
