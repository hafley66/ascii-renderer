...
pub(crate) static MODE_FORMS: &[ModeForm] = &[
    ...
    ModeForm {
        ...
        params: &[
            ...
            param!("CYCLE", "realign seconds", 1.0, 600.0, 120.0, 5.0),
            param!("BASE", "swings per cycle, first", 1.0, 120.0, 20.0, 1.0),
            param!("SWING", "amplitude radians", 0.0, 1.5, 0.5, 0.05),
            param!("VIEW", "0 front, 1 top, 2 waterfall", 0.0, 2.0, 2.0, 1.0),
            param!("TRAIL", "ghost samples", 0.0, 200.0, 8.0, 1.0),
            param!("TAIL", "seconds per ghost", 0.001, 1.0, 0.1, 0.01),
            param!("ASPECT", "cols per row", 0.25, 4.0, 2.0, 0.25),
            param!("HUE", "hue step per bob", 0.0, 90.0, 18.0, 2.0),
            param!("LINK", "envelope line", 0.0, 2.0, 0.0, 1.0),
            param!("ARC", "swing path guide", 0.0, 1.0, 0.0, 1.0),
            param!("ROWDT", "waterfall seconds per row", 0.0005, 2.0, 0.2, 0.02),
    ...
    ModeForm {
        ...
        animate: AnimKind::Iterate,
        params: &[
            param!("P", "polygon sides, 0 seed", 0.0, 12.0, 0.0, 1.0),
            param!("Q", "polygons per vertex, 0 seed", 0.0, 12.0, 0.0, 1.0),
            param!("DEPTH", "reflection cap", 4.0, 64.0, 24.0, 2.0),
            param!("SPEED", "slide units/s", 0.0, 0.5, 0.05, 0.01),
            param!("TWIST", "spin deg/s", -12.0, 12.0, 2.0, 0.5),
            param!("HUE", "hue shift deg", 0.0, 360.0, 0.0, 10.0),
            param!("MODEL", "0 seed, 1 disk, 2 half-plane", 0.0, 2.0, 0.0, 1.0),
            param!("EDGE", "edge band width", 0.0, 0.3, 0.07, 0.01),
            param!("HAZE", "min tile rows", 0.5, 8.0, 2.5, 0.25),
            param!("ARCS", "glowing geodesics", 0.0, 8.0, 3.0, 1.0),
            param!("GLOW", "geodesic glow width", 0.02, 1.0, 0.25, 0.02),
            param!("PETALS", "petal frequency", 0.5, 4.0, 1.0, 0.5),
            param!("FADE", "tile fade distance", 0.5, 8.0, 3.0, 0.25),
            param!("ASPECT", "cols per row", 0.25, 4.0, 2.0, 0.25),
            param!("THREADS", "worker threads, 0 auto", 0.0, 16.0, 0.0, 1.0),
            param!("SWAY", "cross sway units", 0.0, 2.0, 0.4, 0.1),
            param!("LABEL", "show {p,q}", 0.0, 1.0, 1.0, 1.0),
            param!("SPAN", "half-plane half width", 1.0, 8.0, 2.6, 0.2),
            param!("STAR", "vertex star radius", 0.0, 0.5, 0.16, 0.02),
            param!("PULSE", "tile breath depth", 0.0, 0.5, 0.15, 0.05),
            param!("LINE", "min edge width cells", 0.0, 2.0, 0.8, 0.05),
            param!("DETAIL", "tile rows for full fill", 1.0, 30.0, 10.0, 0.5),
            param!("DOTS", "far tile dot radius", 0.0, 1.0, 0.2, 0.05),
            param!("FOCUS", "half-plane focus height", 0.05, 0.95, 0.55, 0.05),
            param!("THICK", "cells before edges go solid", 0.5, 6.0, 1.8, 0.1),
            param!("RINGS", "rings per tile", 0.0, 6.0, 1.5, 0.5),
            param!("DITHER", "fill grain", 0.0, 0.5, 0.08, 0.02),
        ],
    },
    ModeForm {
    ...
    ModeForm {
        ...
        animate: AnimKind::Iterate,
        params: &[
            param!("ENERGY", "tree size fraction of plot", 0.3, 1.2, 0.9, 0.1),
            param!("FRUIT", "fruit chance per tip", 0.0, 1.0, 0.25, 0.05),
            param!("BRANCH", "branching factor", 0.3, 1.5, 1.0, 0.1),
    ...
    ModeForm {
        names: &["fable-2-forest"],
        animate: AnimKind::Iterate,
        params: &[
            param!("DENSITY", "trees per layer", 0.2, 2.0, 1.0, 0.1),
            param!("LAYERS", "depth layers", 1.0, 5.0, 3.0, 1.0),
            ...
            param!("FRUIT", "fruit chance per tip", 0.0, 1.0, 0.15, 0.05),
    ...
    ModeForm {
        ...
        animate: AnimKind::Iterate,
        params: &[
            param!("ENERGY", "energy", 0.3, 1.0, 0.85, 0.05),
            param!("FRUIT", "fruit", 0.0, 1.0, 0.25, 0.05),
            param!("BRANCH", "branch", 0.3, 1.0, 0.7, 0.05),
        ],
    },
    ModeForm {
        names: &["haiku-1-forest"],
        animate: AnimKind::Iterate,
        params: &[
            param!("DENSITY", "density", 0.2, 1.0, 0.8, 0.05),
            param!("LAYERS", "layers", 2.0, 5.0, 3.0, 1.0),
            param!("SWAY", "sway", 0.0, 2.0, 0.5, 0.1),
            param!("SPEED", "speed", 0.1, 1.0, 0.3, 0.05),
            param!("HUE", "hue", 0.0, 1.0, 0.5, 0.05),
