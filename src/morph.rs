...
fn iterate_grid_into(
    ...
    match mode {
        ...
        "tree-of-life-5" => {
            let knobs = crate::lifetree5::Knobs5::from_env();
            crate::lifetree5::draw_lifetree5(grid, w, h, seed, palette, t, &knobs);
            true
        }
        "tree-of-life-6" => {
        ...
        "fable-1-trees" => {
            let knobs = crate::fable_1_trees::SheetKnobs::from_env();
            crate::fable_1_trees::draw_fable_1_trees(grid, w, h, seed, palette, t, &knobs);
            true
        }
        "fable-1-forest" => {
            let knobs = crate::fable_1_forest::ForestKnobs::from_env();
            crate::fable_1_forest::draw_fable_1_forest(grid, w, h, seed, palette, t, &knobs);
            true
        }
        "fable-2-trees" => {
        ...
        "opus-1-forest" => {
            let knobs = crate::opus_1_forest::ForestKnobs::from_env();
        ...
        "aurora2" => {
            let knobs = crate::aurora2::Aurora2Knobs::from_env();
