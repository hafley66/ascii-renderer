...
pub(crate) fn cli_forest5(
    ...
    for ci in 0..cluster_count {
        ...
        let base_hue =
            (ci as f64 * 360.0 / cluster_count as f64 + rng.random_range(0..30u32) as f64) % 360.0;
        ...
        let dom_h = rng.random_range((max_h as u32 / 2).max(8).min(max_h as u32)..max_h as u32 + 1)
            as usize;
...
pub(crate) fn cli_forest7(
    ...
    for si in 0..stop_count {
        ...
        if si > 0 {
            let hop = rng
                .random_range(min_spacing as u32..(min_spacing as u32 * 3).min(width as u32 / 2));
