            ...
            for dy in -ry..=ry {
                for dx in -rx..=rx {
                    ...
                    if nx * nx + ny * ny <= 1.0 {
                        ...
                        grid[y as usize][x as usize] = Cell::new(ch, lighten(water_palette[2], 10));
                    }
                }
            }
        }
