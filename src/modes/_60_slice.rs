...
pub(super) static MODE: Slice = Slice;
pub(super) const PARAMS: &[Param] = &[
    ...
    param!("SL_CUT", "cut px", 8.0, 160.0, 48.0, 1.0),
    param!("SL_ANGLE", "sweep degrees", 0.0, 360.0, 215.0, 1.0),
    param!("SL_JIT", "flight jitter degrees", 0.0, 180.0, 18.0, 1.0),
    param!("SL_DIST", "chord flight distance", 0.3, 3.0, 1.2, 0.1),
    param!("SL_FLIGHT", "flight ms", 60.0, 600.0, 160.0, 10.0),
    param!(
        "SL_ORDER",
        "order",
        0.0,
    ...
    param!("SL_ORD_N", "N beta k", 1.0, 8.0, 2.0, 0.5),
    param!("SL_GAIN", "progression gain", 0.0, 4.0, 1.5, 0.1),
    param!("SL_SILENCE", "gap median ceiling", 1.0, 8.0, 2.5, 0.5),
    param!("SL_SPREAD", "start window ms", 0.0, 3000.0, 800.0, 50.0),
    param!("SL_BURST", "steps curve bins", 1.0, 16.0, 10.0, 1.0),
    param!(
        "SL_FEASE",
        "fease",
        0.0,
    ...
    param!("SL_STRETCH", "chord stretch", 0.0, 2.5, 0.9, 0.05),
    param!("SL_OS", "overshoot", 0.0, 1.4, 0.5, 0.05),
    param!("SL_AILEN", "afterimage length", 0.5, 5.0, 2.0, 0.1),
    param!("SL_AI", "afterimage on", 0.0, 1.0, 1.0, 1.0),
    param!("SL_AI_OPACITY", "afterimage opacity", 0.0, 1.0, 0.85, 0.01),
    param!(
        "SL_AI_FADE",
        "afterimage fade ms",
        20.0,
    ...
    param!("SL_WEIGHT", "moving width", 0.4, 2.5, 1.0, 0.1),
    param!("SL_FINAL_WEIGHT", "landed width", 0.4, 2.5, 1.0, 0.1),
    param!("SL_TIME", "saved cycle position", 0.0, 1.0, 0.0, 0.001),
    param!("SL_SPEED", "clock speed", 0.1, 2.0, 1.0, 0.1),
    param!("SL_RUN", "advance clock", 0.0, 1.0, 1.0, 1.0),
    param!(
        "SL_CORE",
        "core",
        0.0,
    ...
    param!("SL_CORE_SIDES", "core symmetry", 2.0, 9.0, 5.0, 1.0),
    param!(
        "SL_CORE_SIZE",
    ...
    param!("SL_CORE_TURN", "core turn degrees", -90.0, 90.0, 18.0, 1.0),
    param!(
        "SL_CORE_FRAME",
        "core frame",
        0.0,
    ...
    param!("SL_LOOP", "repeat cycle", 0.0, 1.0, 1.0, 1.0),
];
...
const MOTION_PARAMS: &[Param] = &[
    param!("SL_M_TIME", "motion saved position", 0., 1., 0., 0.001),
    param!("SL_M_SPEED", "motion tempo", 0.1, 2., 1., 0.1),
    param!("SL_M_RUN", "motion clock run", 0., 1., 1., 1.),
    param!(
        "SL_M1_TARGET",
        "m1 target",
        0.0,
    ...
    param!("SL_M1_LOW", "motion1 low normalized", 0.0, 1.0, 0.25, 0.01),
    param!(
        "SL_M1_HIGH",
    ...
    param!("SL_M1_DELAY", "motion1 delay ms", 0.0, 8000.0, 0.0, 50.0),
    param!(
        "SL_M1_EASING",
        "m1 easing",
        0.0,
    ...
    param!("SL_M1_LOOP", "motion1 repeat", 0.0, 1.0, 1.0, 1.0),
    param!(
        "SL_M1_DIST",
        "m1 dist",
        0.0,
    ...
    param!("SL_M1_HARMONICS", "motion1 harmonics", 1.0, 8.0, 3.0, 1.0),
    param!("SL_M1_PHASE", "motion1 phase spread", 0.0, 1.0, 1.0, 0.01),
    param!(
        "SL_M1_SEED",
    ...
    param!("SL_M2_LOW", "motion2 low normalized", 0.0, 1.0, 0.25, 0.01),
    param!(
        "SL_M2_HIGH",
    ...
    param!("SL_M2_DELAY", "motion2 delay ms", 0.0, 8000.0, 0.0, 50.0),
    param!(
        "SL_M2_EASING",
        "m2 easing",
        0.0,
    ...
    param!("SL_M2_LOOP", "motion2 repeat", 0.0, 1.0, 1.0, 1.0),
    param!(
        "SL_M2_DIST",
        "m2 dist",
        0.0,
    ...
    param!("SL_M2_HARMONICS", "motion2 harmonics", 1.0, 8.0, 3.0, 1.0),
    param!("SL_M2_PHASE", "motion2 phase spread", 0.0, 1.0, 1.0, 0.01),
    param!(
        "SL_M2_SEED",
    ...
    param!("SL_M3_LOW", "motion3 low normalized", 0.0, 1.0, 0.25, 0.01),
    param!(
        "SL_M3_HIGH",
    ...
    param!("SL_M3_DELAY", "motion3 delay ms", 0.0, 8000.0, 0.0, 50.0),
    param!(
        "SL_M3_EASING",
        "m3 easing",
        0.0,
    ...
    param!("SL_M3_LOOP", "motion3 repeat", 0.0, 1.0, 1.0, 1.0),
    param!(
        "SL_M3_DIST",
        "m3 dist",
        0.0,
    ...
    param!("SL_M3_HARMONICS", "motion3 harmonics", 1.0, 8.0, 3.0, 1.0),
    param!("SL_M3_PHASE", "motion3 phase spread", 0.0, 1.0, 1.0, 0.01),
    param!(
        "SL_M3_SEED",
    ...
    param!("SL_M4_LOW", "motion4 low normalized", 0.0, 1.0, 0.25, 0.01),
    param!(
        "SL_M4_HIGH",
    ...
    param!("SL_M4_DELAY", "motion4 delay ms", 0.0, 8000.0, 0.0, 50.0),
    param!(
        "SL_M4_EASING",
        "m4 easing",
        0.0,
    ...
    param!("SL_M4_LOOP", "motion4 repeat", 0.0, 1.0, 1.0, 1.0),
    param!(
        "SL_M4_DIST",
        "m4 dist",
        0.0,
    ...
    param!("SL_M4_HARMONICS", "motion4 harmonics", 1.0, 8.0, 3.0, 1.0),
    param!("SL_M4_PHASE", "motion4 phase spread", 0.0, 1.0, 1.0, 0.01),
    param!(
        "SL_M4_SEED",
...
pub(super) fn all_params() -> &'static [Param] {
    ...
    P.get_or_init(|| PARAMS.iter().chain(MOTION_PARAMS).cloned().collect())
}
fn motion_config(k: &[f64]) -> serde_json::Value {
    ...
    serde_json::json!({"transport":{"time":v(0),"speed":v(1),"run":v(2)>=0.5},"timing":{"duration":span,"loop":true},"sections":{"slice":{"fields":fields}}})
}
...
mod motion_tests {
    ...
    fn all_live_keys_are_unique_and_defaults_resolve() {
        ...
        assert_eq!(all_params().len(), 103);
        assert_eq!(animation_params().len(), 97);
        assert!(
            animation_params()
                .iter()
